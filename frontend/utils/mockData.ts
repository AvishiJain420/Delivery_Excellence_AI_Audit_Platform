...
export const mockAuditHistory: AuditSummary[] = [
  { id: 'a001', name: 'Project Atlas — BRD Audit', projectName: 'Project Atlas', status: 'running',   documentCount: 14, overallScore: undefined, framework: 'ISO 27001', duration: undefined, createdAt: new Date(Date.now() - 1000 * 60 * 22).toISOString() },
  { id: 'a002', name: 'Phoenix — Compliance Review', projectName: 'Project Phoenix', status: 'completed', documentCount: 9,  overallScore: 91, framework: 'GDPR', duration: '14m 32s', createdAt: new Date(Date.now() - 1000 * 60 * 95).toISOString() },
  { id: 'a003', name: 'Titan Architecture Audit',   projectName: 'Project Titan',   status: 'completed', documentCount: 21, overallScore: 78, framework: 'SOC 2',   duration: '28m 11s', createdAt: new Date(Date.now() - 1000 * 60 * 60 * 6).toISOString() },
  { id: 'a004', name: 'Zenith Security Assessment', projectName: 'Project Zenith',  status: 'failed',    documentCount: 7,  overallScore: undefined, framework: 'NIST', duration: '3m 08s', createdAt: new Date(Date.now() - 1000 * 60 * 60 * 12).toISOString() },
  { id: 'a005', name: 'Orion API Governance',       projectName: 'Project Orion',   status: 'completed', documentCount: 5,  overallScore: 95, framework: 'Internal', duration: '9m 44s', createdAt: new Date(Date.now() - 1000 * 60 * 60 * 26).toISOString() },
  { id: 'a006', name: 'Nova Data Quality Audit',    projectName: 'Project Nova',    status: 'completed', documentCount: 31, overallScore: 62, framework: 'ISO 27001', duration: '41m 05s', createdAt: new Date(Date.now() - 1000 * 60 * 60 * 48).toISOString() },
]
